<template>
  <section class="add-wrap">
    ...
    >
      ...
      <el-table-column prop="hotId" label="hotId" sortable width="160"></el-table-column>
      <el-table-column prop="hotTitle" label="hotTitle" sortable></el-table-column>
      <el-table-column prop="hotUrl" label="hotUrl" sortable></el-table-column>
      <el-table-column prop="hotImg" width="400" label="图片地址">
        <template slot-scope="scope">
          <a
            style="color: #2593FC;"
            :href="scope.row.hotImg"
            target="_blank"
            rel="noopener noreferrer"
          >{{scope.row.hotImg}}</a>
        </template>
      </el-table-column>
      <el-table-column prop="hotImg" label="操作">
        <template slot-scope="scope">
...
@Component({})
export default class HotSwiperList extends Vue {
