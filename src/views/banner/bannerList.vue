<template>
  <section class="add-wrap">
    ...
    >
      ...
      <el-table-column prop="bannerId" label="bannerId" sortable width="120"></el-table-column>
      <el-table-column prop="bannerTitle" label="bannerTitle" sortable></el-table-column>
      <el-table-column prop="bannerImg" width="500" label="图片地址">
        <template slot-scope="scope">
          <a
            style="color: #2593FC;"
            :href="scope.row.bannerImg"
            target="_blank"
            rel="noopener noreferrer"
          >{{scope.row.bannerImg}}</a>
        </template>
      </el-table-column>
      <el-table-column prop="bannerImg" label="操作">
        <template slot-scope="scope">
